      ...
      {text}
        ...
        <div>
          ...
          <div className='flex flex-col gap-2'>
            ...
            type="date" name="" id="pickup-date" required className='border border-borderColor px-3 py-2 rounded-lg' min={new Date().toISOString().split('T')[0]} />
          </div>
          <div className='flex flex-col gap-2'>
            <label htmlFor="return-date">Return Date</label>
            <input
              value={returnDate} onChange={(e)=>setReturnDate(e.target.value)}
            type="date" name="" id="return-date" required className='border border-borderColor px-3 py-2 rounded-lg' />
          </div>
