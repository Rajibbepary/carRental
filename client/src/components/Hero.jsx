...
const Hero = () => {
  ...
  return (
    ...
    <form className='flex flex-col md:flex-row items-center md:items-center justify-between p-6 mt-10 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
...
<input type='date' id='pickup-date' min={new Date().toISOString().split('T')[0]} className='text-gray-500 text-sm' required/>
</div>
<div className='flex flex-col items-start gap-2'>
<label htmlFor='return-date'>Return Date</label>
<input type='date' id='return-date' className='text-gray-500 text-sm' required/>
</div>
    </div>
