    ...
    return (
        <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
            <div className='group relative'>
                    <label htmlFor='image'>
                        <img src={image ? URL.createObjectURL(image) : user?.image || 'https://unsplash.com/photos/man-in-black-hoodie-wearing-black-framed-eyeglasses-3JmfENcL24M'} alt=""  className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto' />
            ...
            <div className='w-full'>
                ...
                {Array.isArray(ownerMenuLinks) && ownerMenuLinks.map((link, index) => (
                    link?.path && (
                    <NavLink
                        key={index}
                        to={link.path}
